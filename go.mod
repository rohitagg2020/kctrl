module github.com/rohitagg2020/kctrl
...
require (
	...
	github.com/vmware-tanzu/carvel-kapp-controller/cli v0.0.0-20220322191224-e6f78c7ab1f2
...
require (
	...
	k8s.io/api v0.22.1 // indirect; kubernetes-1.22.1
